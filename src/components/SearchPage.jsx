...
function SearchPage({ searchQuery }) {
    ...
    }, [searchQuery, selectedCategories, selectedPriceRanges]);
                    ...
                    <div className="space-y-4">
                        {filteredProducts.map((item) => (
                            <div key={item.product_id} className="bg-white p-4 rounded-lg shadow flex flex-col sm:flex-row">
                                <div className="w-full sm:w-48 h-48 flex-shrink-0 mb-4 sm:mb-0 bg-gray-50 flex items-center justify-center">
                                    <ProductImage
                                        src={item.img_link}
                                    ...
                                    <div className="mt-2">
                                        ...
                                        {item.actual_price && (
                                            <>
                                                ...
                                                <span className="text-sm text-[#CC0C39] ml-2">({item.discount_percentage} off)</span>
                                            </>
                                        )}
                                    </div>
                        ...
                        {filteredProducts.length === 0 && (
                            <div className="text-center py-8">
                                ...
                                <p className="text-gray-600">We couldn't find any matches for "{searchQuery}"</p>
                            </div>
                        )}
                    </div>
                </div>
